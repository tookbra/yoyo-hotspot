...
public class Lease {
    ...
    private Boolean expiredSms;

    /**
     * 即将到期短信是否发送 0否 1是
     */
    @Column(name = "sms_expiring")
    private Boolean smsExpiring;

    /**
     * 封顶短信提醒 0否 1是
     */
    @Column(name = "sms_cap")
    private Boolean smsCap;
     ...
     */
    public void setExpiredSms(Boolean expiredSms) {
     ...
     */
    public void setSmsExpiring(Boolean smsExpiring) {
     ...
     */
    public void setSmsCap(Boolean smsCap) {
        this.smsCap = smsCap;
    }
