package com.mars.yoyo.hotspot.auth.util.jwt;

import com.mars.yoyo.hotspot.auth.constatns.JwtConstants;
...
public class JWTHelper {
    ...
    public static IJWTInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
        ...
        return new JWTInfo(body.getSubject(), StringUtil.objectToEmpty(body.get(JwtConstants.JWT_KEY_USER_ID)),
                StringUtil.objectToEmpty(body.get(JwtConstants.JWT_KEY_NAME)));
    }
    /**
     * 获取token中的用户信息
     *
