                ...
                <div class="ibox-content">
                    ...
                    <form class="form-inline" id="search_form" name="search_form">
                        <div class="form-group">
                            <label class="control-label" for="bannerName">关键词:</label>
                            <input class="form-control" type="text" id="bannerName" name="bannerName" placeholder="广告标题"/>
                        </div>

                        <button style="margin-top: 5px;" type="button" id="search" class="btn btn-success" onclick="searchBanner()">
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list").bootstrapTable({
            ...
            // 数据列
            columns: [
                {title: "广告标题", field: "name" },
                {title: "图片地址", field: "imgUrl" },
                {title: "视频地址", field: "videoUrl" },
    ...
    function queryParams(params) {
        return {
            ...
            searchText: $('#search_form input[name=\'bannerName\']').val(),
        }
    }
    ...
    function searchBanner() {
        ...
        $('#search_form input[name=\'bannerName\']').val();
    }
    ...
    function edit(bannerId){
        layer.open({
            ...
            shade: false,
            area: ['893px', '600px'],
            content: '/banner/preEdit/' + bannerId,
            end: function(index){
                $('#table_list').bootstrapTable("refresh");
            }
        });
