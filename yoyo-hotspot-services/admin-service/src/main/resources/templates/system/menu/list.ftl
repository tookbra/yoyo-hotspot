            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-inline" id="search_form" name="search_form">
                        ...
                        <button style="margin-top: 5px;" type="button" id="search" class="btn btn-success" onclick="searchMenu()">
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list").bootstrapTable({
            ...
            columns: [
                ...
                {title: "菜单URL", field: "href"},
                {title: "父菜单", field: "parentTitle" },
                {title: "排序", field: "sort"},
    ...
    function queryParams(params) {
        return {
            ...
            searchText: $('#search_form input[name=\'title\']').val(),
        }
    }
    ...
    function searchMenu() {
        ...
        $('#search_form input[name=\'title\']').val();
    }
