                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-inline" id="search_form" name="search_form">
                            <div class="form-group">
                                <label class="control-label" for="templateName">关键词:</label>
                                <input class="form-control" type="text" id="templateName" name="templateName" placeholder="标题/编号/内容"/>
                            </div>

                            <button style="margin-top: 5px;" type="button" id="search" class="btn btn-success" onclick="searchTemplate()">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#table_list").bootstrapTable({
                ...
                // 数据列
                columns: [
                    {title: "模版标题", field: "name" },
                    {title: "模版编号", field: "code" },
                    {title: "模版内容", field: "content" },
        ...
        function queryParams(params) {
            return {
                ...
                searchText: $('#search_form input[name=\'templateName\']').val(),
            }
        }
        ...
        function searchTemplate() {
            ...
            $('#search_form input[name=\'templateName\']').val();
        }
        ...
        function edit(templateId){
            layer.open({
                ...
                shade: false,
                area: ['893px', '600px'],
                content: '/template/preEdit/' + templateId,
                end: function(index){
                    $('#table_list').bootstrapTable("refresh");
                }
            });
